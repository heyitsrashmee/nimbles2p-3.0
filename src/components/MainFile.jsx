...
/* Typewriter hook — cycles through words with type/erase animation */
...
function NimbleLogo({ height = 28 }) {
  return (
    <svg height={height} viewBox="0 0 457 91" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display:"block" }}>
...
function NimbleColorLogo({ height = 28 }) {
  const aspect = 456 / 91;
  return (
    <svg height={height} width={height * aspect} viewBox="0 0 456 91" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M65.0601 25.35H53.3101C57.1801 27.94 61.0801 30.56 63.9401 32.5H65.0601C67.0301 32.5 68.6301 30.9 68.6301 28.93C68.6301 26.96 67.0301 25.36 65.0601 25.36V25.35Z" fill="#FCB216"/>
      ...
      <path d="M143.56 25.39C147.155 25.39 150.07 22.4754 150.07 18.88C150.07 15.2846 147.155 12.37 143.56 12.37C139.965 12.37 137.05 15.2846 137.05 18.88C137.05 22.4754 139.965 25.39 143.56 25.39Z" fill="#3E2C80"/>
...
function ScaledWorkflowDemo({ modId }) {
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      const s = Math.min(width / WORKFLOW_W, height / WORKFLOW_H) * 0.98;
      setScale(Math.max(0.12, Math.min(s, 1)));
    };
    measure();
...
/* ════════════════════════════════════
   ROOT PAGE
════════════════════════════════════ */
function WhyNimblePage({ onBack, onNavigate }) {
  useEffect(()=>{ window.scrollTo(0,0); },[]);
  return (
    <>
...
/* ════════════════════════════════════
   ROOT PAGE
════════════════════════════════════ */
function PricingPage({ onBack, onNavigate }) {
  useEffect(()=>{ window.scrollTo(0,0); },[]);
  return (
    <>
