...
const PRESS_ARTICLES = [
  ...
  { pub: "Global Tech Outlook", title: "Top 5 SaaS Solutions for Procurement Automation", excerpt: "Robust solutions are streamlining functionalities associated with business requirements across multiple departments.", href: "https://www.globaltechoutlook.com/top-5-saas-solutions-for-procurement-automation/" },
  ...
  { pub: "CXO Outlook", title: "5 Brands Providing P2P and S2P Solutions", excerpt: "Both P2P and S2P solutions improve collaborative capability during sourcing — creating urgent vendor demand.", href: "https://nimbles2p.com/press/" },
  ...
  { pub: "Silicon India", title: "Leveraging Technology for Better Supplier Relationship Management", excerpt: "Modern firms consistently strive to adapt to extraordinary market changes with tech-driven strategies.", href: "https://startup.siliconindia.com/viewpoint/cxoinsights/the-future-of-procurement-leveraging-technology-for-better-supplier-relationship-management-nwid-38773.html" },
  ...
  { pub: "The Times of India", title: "Major Steps To Improve Your Supplier Performance Management", excerpt: "Organizations must constantly adapt to changing market conditions and supply chain disruptions.", href: "https://bwretailworld.businessworld.in/news/major-steps-to-improve-your-supplier-performance-management" },
  { pub: "BW Retailworld", title: "Predictive Procurement; Relevance for Supply Chain", excerpt: "Managing supplier performance is more important than ever in today's fast-paced business environment.", href: "https://timesofindia.indiatimes.com/blogs/voices/predictive-procurement-relevance-for-supply-chain-functioning-across-organizations/" },
];
